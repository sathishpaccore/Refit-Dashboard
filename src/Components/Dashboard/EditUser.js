        ...
        if(!dataObject.Name){
         ...
         try {
            ...
            const obj = {
              ...
              "LoginUser":location.state.data.UserID,
              "Password":dataObject.password
            }
             
                const dert = await getusersService.edituser(obj)
          ...
          <div class="row">
            <div class="col-12">
              <div style={{borderRadius:'0px'}} class="card">
                ...
                <div style={{textAlign:'center',fontSize:'24px',marginBottom:'10px'}}><b>Edit User</b></div>
                  <div>
                  <fieldset>
